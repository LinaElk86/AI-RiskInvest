...
if user_input:
    ...
    if any(w in q for w in ["hello", "bonjour", "salam", "who", "شكون", "من انت"]):
        ...
        reply = (
            ...
            "• Utilisez toujours stop-loss et diversification"
        )
        ...
        reply = (
            ...
            "Elles peuvent cependant influencer fortement les prix."
        )
